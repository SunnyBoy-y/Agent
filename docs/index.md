...
9. `todo_discussion.md`
   - 与产品/实现相关的待确认事项。
   - 记录已确认规则和剩余开放问题。

10. `timed_event_and_medication_reminder_design.md`
...
- 当前代码真实实现的核心接口仍是 `/api/chat`、画像、系统状态、主动关怀和重置接口。
- family/community/music/action_complete/mental_assessments/planner/family_chat 等接口仍是拟新增接口。
...
- 下一步最稳的代码顺序是：
  ...
  6. CarePlan/后台 Planner/消息联动/多端接口。
